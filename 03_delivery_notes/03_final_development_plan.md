...
- 최초 작성일자: 2026-05-13
- 업데이트일자: 2026-05-13
- 업데이트 내용: GitHub Pages 정적 배포, Firebase Realtime Database 저장, 런타임 OpenAI key 기반 AI 분석과 3종 리포트 동시 생성 구조로 최종 구조 재정리.
- 작성자: Codex
...
5. AI 분석 결과는 종합, 비주관식, 주관식 문항별 리포트로 나누어 Firebase에 저장한다. 어느 리포트 탭에서 생성 버튼을 눌러도 3종이 동시에 생성되며, key 자체는 소스, GitHub secret, Firebase 어디에도 저장하지 않는다.
...
7. 워크샵 진행자가 AI 리포트 탭 중 하나에서 생성 버튼을 누르고, 종합, 비주관식, 주관식 문항별 AI 리포트 3종이 모두 Firebase에 저장되는지 확인한다.
