...
const reportSpecs = {
  comprehensive: {
   ...
   - 첫 줄은 반드시 "**한 문장 결론:** ..." 형식으로 작성하세요. 읽는 사람이 결과를 한 번에 이해해야 합니다.
   - 이어서 "## 쉬운 분석 요약"을 만들고, 설문 결과를 쉬운 말로 5~8개 bullet로 풀어쓰세요.
   - 이어서 "## 그래서 무엇을 해야 하나"를 만들고, 바로 실행할 제안 3~5개를 bullet로 작성하세요.
...
9. ## 8. 다음 설문 또는 추가 확인 항목
  ...
  closedEnded: {
    ...
    requiredSections: `1. # Executive Summary
   - 첫 줄은 반드시 "**한 문장 결론:** ..." 형식으로 작성하세요. 정량 결과의 핵심을 한 문장으로 말해야 합니다.
   - 이어서 "## 쉬운 분석 요약"을 만들고, 정량 문항에서 보이는 핵심 신호 5~8개를 쉬운 한국어 bullet로 요약하세요.
   - 이어서 "## 그래서 무엇을 해야 하나"를 만들고, 정량 결과만 보고도 시작할 수 있는 제안 3~5개를 bullet로 작성하세요.
2. ## 1. 정량 데이터 범위와 한계
...
7. ## 6. 4주 실행 실험 후보
  ...
  textByQuestion: {
    ...
    requiredSections: `1. # Executive Summary
   - 첫 줄은 반드시 "**한 문장 결론:** ..." 형식으로 작성하세요. 주관식 응답의 핵심 정서를 한 문장으로 말해야 합니다.
   - 이어서 "## 쉬운 분석 요약"을 만들고, 주관식 응답 전체에서 보이는 핵심 테마 5~8개를 쉬운 한국어 bullet로 요약하세요.
   - 이어서 "## 그래서 무엇을 해야 하나"를 만들고, 워크샵에서 바로 다룰 제안 3~5개를 bullet로 작성하세요.
...
- Executive Summary 이후 모든 큰 섹션은 반드시 첫 부분에 "**한문장 정리:** ..."와 "**한문장 제안:** ..."을 각각 한 줄씩 넣고, 그 아래에 상세 근거와 해석을 작성하세요.
- "한문장 정리"는 그 섹션에서 관찰한 사실 또는 해석을 한 문장으로 말합니다.
- "한문장 제안"은 그 섹션을 읽고 워크샵에서 무엇을 해야 하는지 한 문장으로 말합니다.
